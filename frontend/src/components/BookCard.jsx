...
const BookCard=({book,setBooks})=>{
    ...
    <>
        ...
        <div className="mt-6 flex justify-between items-center">
            <span className="text-xs text-base-content/60">{formatDate(new Date(book.createdAt))}</span>

            {/*Action Icon*/}
            <div className="flex items-center gap-4">
                {/*EDIT*/}
                <div className="tooltip tooltip-error" data-tip="Edit book">
        ...
        {showModal && (<dailog className="modal modal-open">
